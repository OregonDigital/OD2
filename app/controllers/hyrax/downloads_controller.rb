...
module Hyrax
  # This is a rewrite of key sections of the Hyrax DownloadsController so we
  # can use S3 everywhere we need it, rather than trying to find things locally
  # on disk.  We have to keep around some of the local file behaviors for the
  # (hopefully very rare) static files like the default image.

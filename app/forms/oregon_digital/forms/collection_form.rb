  ...
  module Forms
    ...
    class CollectionForm < Hyrax::Forms::CollectionForm
      self.terms = %i[id title creator contributor description license publisher
                      ...
                      content_alert mask_content accessibility_feature accessibility_summary]
      ...
      def self.build_permitted_params
        params = super
        %w[creator contributor institution repository publisher subject local_contexts content_alert mask_content accessibility_feature accessibility_summary].each do |prop|

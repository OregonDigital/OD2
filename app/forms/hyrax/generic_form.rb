...
module Hyrax
  ...
  class GenericForm < Hyrax::Forms::WorkForm
    ...
    self.terms += [:resource_type, :oembed_url, :alternative, :caption_title, :tribal_title, :arranger, :artist, :author, :cartographer, :collector, :composer, :creator_display, :dedicatee, :donor, :designer, :editor, :former_owner, :illustrator, :interviewee, :interviewer, :lyricist, :owner, :patron, :photographer, :print_maker, :recipient, :scribe,
                   ...
                   :military_service_location, :mode_of_issuance, :mods_note, :object_orientation, :original_name_usage, :tribal_notes, :source_cdcmi_ondition, :specimentype, :temporal, :taxon_class, :cultural_context, :ethnographic_term, :event, :family, :genus, :order, :species, :subject, :military_branch, :phylum_or_division, :sports_team,
                   ...
                   :local_collection_name, :location_copyshelf_location, :publisher, :language, :place_of_production, :provenance, :publication_place, :repository, :source, :series_name, :series_number, :art_series, :has_finding_aid, :has_part, :has_version, :is_part_of, :is_version_of, :has_part, :relation, :dcmi_type, :work_type, :extent, :format,

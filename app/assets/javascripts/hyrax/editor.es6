...
import SingleControlledVocabulary from 'hyrax/editor/single_controlled_vocabulary'
...
export default class {
  ...
  init() {
    ...
    this.singleControlledVocabularies()
    this.sharingTab()
  ...
  // initialize any controlled vocabulary widgets
  singleControlledVocabularies() {
    this.element.find('.single_controlled_vocabulary.form-group').each((_idx, controlled_field) =>
      new SingleControlledVocabulary(controlled_field, this.paramKey)
    )
  }

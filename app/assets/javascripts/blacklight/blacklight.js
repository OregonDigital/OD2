...
console.log('foo');
Blacklight.modal.triggerLinkSelector = 'button[data-blacklight-modal~=trigger]';
...
Blacklight.modal.setupModal = function () {
  ...
  $('body').on('click', Blacklight.modal.modalSelector + ' button[data-dismiss~=modal]', function (e) {
    e.preventDefault();
  });

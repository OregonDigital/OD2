...
module OregonDigital
  ...
  module GenericMetadata
    ...
    CONTROLLED = %w[format_label].freeze
    ...
    included do
      ...
      property :based_near, predicate: ::RDF::Vocab::FOAF.based_near, class_name: OregonDigital::ControlledVocabularies::ExtendedLocation
      ...
      self.controlled_properties = %i[based_near format]

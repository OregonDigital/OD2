...
module OregonDigital
  ...
  module GenericMetadata
    ...
    CONTROLLED = %w[based_near_label format_label local_collection_name_label tgn_label].freeze
    ...
    included do
      ...
      self.controlled_properties = %i[based_near format local_collection_name tgn]

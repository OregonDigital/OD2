...
module OregonDigital
  ...
  module GenericMetadata
    ...
    CONTROLLED = %w[based_near_label ethnographic_term_label format_label local_collection_name_label publisher_label repository_label tgn_label].freeze
    ...
    included do
      ...
      self.controlled_properties = %i[based_near ethnographic_term format local_collection_name publisher repository tgn]

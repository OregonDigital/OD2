...
module OregonDigital
  ...
  module GenericMetadata
    ...
    CONTROLLED = %w[arranger_label artist_label author_label based_near_label cartographer_label collector_label composer_label contributor_label creator_label cultural_context_label dedicatee_label designer_label donor_label editor_label ethnographic_term_label form_of_work_label format_label illustrator_label institution_label interviewee_label interviewer_label local_collection_name_label lyricist_label owner_label patron_label photographer_label print_maker_label publisher_label recipient_label repository_label scribe_label style_or_period_label tgn_label transcriber_label translator_label workType_label].freeze
    ...
    included do
      ...
      self.controlled_properties = %i[arranger artist author based_near cartographer collector composer contributor creator cultural_context dedicatee designer donor editor ethnographic_term form_of_work format illustrator institution interviewee interviewer local_collection_name lyricist owner patron photographer print_maker publisher recipient repository scribe style_or_period tgn transcriber translator workType]

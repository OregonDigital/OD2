...
module OregonDigital
  ...
  module GenericMetadata
    ...
    included do
      ...
      ORDERED_TERMS = [
        { name: :alternative, section_name: 'Titles', begin_section: true },
        { name: :tribal_title, section_name: '' },
        { name: :title, section_name: '', end_section: true },
        { name: :creator, section_name: 'Creators', begin_section: true  },
        ...
        { name: :translator, section_name: '', end_section: true },
        { name: :description, section_name: 'Descriptions', begin_section: true  },
        ...
        { name: :temporal, section_name: '', end_section: true },
        { name: :subject, section_name: 'Subjects', begin_section: true  },
        ...
        { name: :tribal_terms, section_name: '', end_section: true },
        { name: :phylum_or_division, section_name: 'Scientifics', begin_section: true  },
        ...
        { name: :identification_verification_status, section_name: '', end_section: true },
        { name: :location, section_name: 'Geographics', begin_section: true  },
        ...
        { name: :water_basin, section_name: '', end_section: true },
        { name: :date, section_name: 'Dates', begin_section: true  },
        ...
        { name: :view_date, section_name: '', end_section: true },
        { name: :accession_number, section_name: 'Identifiers', begin_section: true  },
        ...
        { name: :longitude_latitude_identification, section_name: '', end_section: true },
        { name: :license, section_name: 'Rights', begin_section: true  },
        ...
        { name: :use_restrictions, section_name: '', end_section: true },
        { name: :repository, section_name: 'Sources', begin_section: true  },
        ...
        { name: :source, section_name: '', end_section: true },
        { name: :art_series, section_name: 'Relations', begin_section: true  },
        ...
        { name: :related_url, section_name: '', end_section: true },
        { name: :resource_type, section_name: 'Types', begin_section: true  },
        { name: :workType, section_name: '', end_section: true },
        { name: :material, section_name: 'Formats', begin_section: true  },
        { name: :measurements, section_name: '' },
        { name: :physical_extent, section_name: '' },
        { name: :technique, section_name: '', end_section: true },
        { name: :conversion, section_name: 'Administratives', begin_section: true  },
        ...
        { name: :date_uploaded, section_name: '', end_section: true }
      ].freeze
    end
  end
end

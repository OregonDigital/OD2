...
module OregonDigital
  ...
  module GenericMetadata
    ...
    included do
      ...
      self.controlled_properties = %i[arranger artist author based_near cartographer collector composer contributor creator cultural_context dedicatee designer donor editor ethnographic_term format illustrator institution interviewee interviewer local_collection_name lyricist owner patron photographer print_maker publisher recipient repository scribe style_or_period tgn transcriber translator]

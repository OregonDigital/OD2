  ...
  module DocumentMetadata
    ...
    included do
      ...
      ORDERED_TERMS = [
        ...
        { name: :first_line, section_name: '' },
        { name: :first_line_chorus, section_name: '' },
        { name: :form_of_work, section_name: '' },
        { name: :former_owner, section_name: '' },
        { name: :inscription, section_name: '' },
        { name: :instrumentation, section_name: '' },
        ...
        { name: :table_of_contents, section_name: '' },

...
module Bulkrax
  ...
  module HasLocalProcessing
    ...
    def factory
      @factory ||= Bulkrax::OregonDigitalObjectFactory.new(attributes: parsed_metadata, source_identifier_value: identifier, work_identifier: work_identifier, replace_files: replace_files, user: user, klass: factory_class, update_files: update_files)
    end

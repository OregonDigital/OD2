...
class SolrDocument
  ...
  field_semantics.merge!(
    ...
    coverage: %w[coverage_tesim temporal_tesim location_label_tesim box_tesim gps_latitude_tesim gps_longitude_tesim ranger_district_label_tesim street_address_tesim tgn_label_tesim water_basin_label_tesim, plss_label_tesim],

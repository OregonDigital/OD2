...
class GenericIndexer < Hyrax::WorkIndexer
  ...
  def generate_solr_document
    super.tap do |solr_doc|
      ...
      solr_doc['hocr_text_timv'] = object.file_sets.map { |file_set| file_set.hocr_text }
      solr_doc['hocr_text_tsimv'] = object.file_sets.map { |file_set| file_set.hocr_text }
      solr_doc['hocr_content_tsimv'] = object.file_sets.map { |file_set| file_set.hocr_content }

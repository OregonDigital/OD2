...
module Hyrax
	...
	class CollapsableSectionPresenter
	  ...
	  def button_tag
	    tag.a(role: 'button',
		  type: "button",
		  class: "#{button_class}collapse-toggle collapse activity-toggle",
		  data: { toggle: 'collapse' },
		  href: "##{id}",
		  onclick: "toggleCollapse(this)",
		  aria: { expanded: true, controls: id}) do
	  ...
	  def list_tag
	    tag.ul(class: "collapse #{workflows_class}nav nav-pills nav-stacked dropdown",
		   id: id) do
	      yield
	    end
	  end

...
RSpec.describe Qa::Authorities::ExtendedGeonames do
  ...
  describe '#search' do
    ...
    it { expect(geonames_instance.search('http://my.queryuri.com')).to eq [{ 'id': 'http://sws.geonames.org/myId/', 'label': 'name, adminName1, countryName, (Administrative Boundary)' }.with_indifferent_access] }
  end
end

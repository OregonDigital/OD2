...
RSpec.describe Qa::Authorities::ExtendedGeonames do
  ...
  it { geonames_instance.label.call(label_hash, fcl) eq 'my_label'}
  describe "#search" do
    before do
    ...
    it { geonames_instance.search('http://my.queryuri.com') eq [{'id': 'http://sws.geonames.org/myId/', 'label': 'name, adminName1, countryName, Area'}] }
  end
end

...
RSpec.describe OregonDigital::ControlledVocabularies::Vocabularies::GettyUlan do
  ...
  let(:data) { [{ 'identified_by': [{ 'classified_as': [{ 'id': 'http://vocab.getty.edu/term/type/Descriptor' }], 'content': 'blah' }], 'id': 'http://vocab.getty.edu/ulan/term_id' }.with_indifferent_access] }
